...
from .vehicleAgent import update_vehicle_state
    ...
    try:
        ...
        with CarlaSyncMode(world, camera_rgb, camera_semseg, fps=30) as sync_mode:
            while True:
                ...
                update_vehicle_state(image_rgb, waypoint, snapshot.timestamp.delta_seconds)
                ...
                print('landmarks = ', waypoint.get_landmarks(10))
                print('\n')
